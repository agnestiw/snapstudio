...
// Tilt effect for testimonial card
...
testimonialCard.style.transform = `perspective(1000px) rotateX(${tiltX}deg) rotateY(${tiltY}deg)`;
});

testimonialCard.addEventListener('mouseleave', () => {
testimonialCard.style.transform = 'perspective(1000px) rotateX(0) rotateY(0)';
});
}
...
const sections = ['hero', 'fitur', 'layanan', 'testimoni', 'kontak'];
let currentSection = '';
